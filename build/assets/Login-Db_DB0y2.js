import { u, r as x, j as e, H as g } from "./app-ISxEiS1S.js";
import { C as b } from "./Checkbox-BaVb8NSd.js";
import { I as o } from "./InputError-BeX5CBml.js";
import { I as i } from "./InputLabel-Cg62RQsb.js";
import { P as f } from "./PrimaryButton-CY_yXSaT.js";
import { T as c } from "./TextInput-BXwS4CZ-.js";
import "./app-DEV1gfeS.js";
function R({ status: t, canResetPassword: h }) {
  const {
    data: s,
    setData: a,
    post: n,
  ...
  const p = (r) => {
    r.preventDefault(), n(route("login-to-manager.store"));
  };
  return e.jsxs("div", {
    className:
                    ...
                    children: e.jsxs("svg", {
                      ...
                      children: [
                        ...
                        e.jsxs("g", {
                          ...
                          children: [
                            " ",
                            e.jsx("title", { children: "codeigniter" }),
                            " ",
                            e.jsx("path", {
            ...
            children: [
              e.jsxs("div", {
                children: [
                  ...
                  e.jsx(o, { message: l.email, className: "mt-2" }),
                ],
              }),
              e.jsxs("div", {
                className: "mt-4",
                children: [
                  ...
                  e.jsx(o, { message: l.password, className: "mt-2" }),
                ],
              }),
              e.jsx("div", {
                ...
                children: e.jsxs("label", {
                  ...
                  children: [
                    e.jsx(b, {
                      name: "remember",
                      checked: s.remember,
                      onChange: (r) => a("remember", r.target.checked),
                      className:
