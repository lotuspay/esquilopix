...
<div
    ...
    <div class="flex flex-col gap-9 px-6 py-[22px] h-screen overflow-y-auto overflow-x-hidden">
        <div>
            <h4 class="font-semibold text-black dark:text-white mb-5">Notificações</h4>
                ...
                <div class="flex gap-2">
                    ...
                    <div class="flex-1">
                        <p class="whitespace-nowrap overflow-hidden text-ellipsis w-[200px] text-black dark:text-white">
                            Atualização Path 0.035</p>
                        <p class="text-xs text-black/40 dark:text-white/40">Phillyps</p>
                    </div>
                </div>
                <div class="flex gap-2">
                    <div class="h-6 w-6 flex-none p-1 text-black bg-lightblue-100 rounded-lg">
